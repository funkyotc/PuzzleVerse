...
def main():
    ...
    sb.append("    )")
    sb.append("")
    sb.append("    val PUZZLES_BY_DIFFICULTY: Map<String, List<BrowseablePuzzle>> = ALL_PUZZLES.groupBy { it.difficulty }")
    sb.append("")
    ...
    sb.append("        }")
    sb.append("        return ALL_PUZZLES.filter { it.difficulty == diffName }.randomOrNull()")
    sb.append("    }")
    sb.append("}")
    sb.append("")
